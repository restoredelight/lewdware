...
<div class="mx-auto w-full max-w-[800px] p-6 max-[600px]:p-4">
	<header class="mb-5">
		<h2 class="ui-page-title">Pack Metadata</h2>
		<p class="text-muted mt-1 mb-0 text-[13px]">
			The name, attribution, and version shipped with this pack.
		</p>
	</header>
