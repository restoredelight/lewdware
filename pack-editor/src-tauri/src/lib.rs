...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            behaviour::stage::restrict_stage_content,
            behaviour::stage::unrestrict_stage_content,
            behaviour::stage::set_stage_membership,
            behaviour::stage::add_stage_exclude_tag,
            behaviour::stage::remove_stage_exclude_tag,
