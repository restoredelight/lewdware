...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Behaviour: queries first, then one command per author action.
            behaviour::queries::get_behaviour_summary,
            behaviour::queries::get_text_pool,
            behaviour::queries::get_web_links,
            behaviour::queries::get_content_groups,
            behaviour::queries::get_media_slots,
            behaviour::queries::get_popup_attributes,
            behaviour::queries::get_audio_attributes,
            behaviour::queries::get_timeline,
            behaviour::pool::set_text_item_text,
            behaviour::pool::set_text_item_summary,
            behaviour::pool::set_text_item_timeout,
            behaviour::pool::set_text_item_tags,
            behaviour::pool::add_text_item,
            behaviour::pool::remove_text_item,
            behaviour::pool::add_text_item_tag,
            behaviour::pool::remove_text_item_tag,
            behaviour::link::set_web_link_url,
            behaviour::link::set_web_link_args,
            behaviour::link::set_web_link_tags,
            behaviour::link::add_web_link,
            behaviour::link::remove_web_link,
            behaviour::link::add_web_link_tag,
            behaviour::link::remove_web_link_tag,
            behaviour::link::add_web_link_arg,
            behaviour::link::remove_web_link_arg,
            behaviour::group::set_content_group_label,
            behaviour::group::set_content_group_description,
            behaviour::group::set_content_group_enabled_by_default,
            behaviour::group::set_content_group_tags,
            behaviour::group::add_content_group,
            behaviour::group::remove_content_group,
            behaviour::group::add_content_group_tag,
            behaviour::group::remove_content_group_tag,
            behaviour::timeline::set_timeline_enabled,
            behaviour::timeline::set_timeline_label,
            behaviour::stage::add_stage,
            behaviour::stage::duplicate_stage,
            behaviour::stage::move_stage,
            behaviour::stage::remove_stage,
            behaviour::stage::set_stage_label,
            behaviour::stage::set_stage_content_tags,
            behaviour::stage::set_stage_content_tags_many,
            behaviour::stage::add_stage_tag,
            behaviour::stage::remove_stage_tag,
            behaviour::stage::set_stage_audio_random,
            behaviour::stage::set_stage_event,
            behaviour::stage::set_stage_entry_notification,
            behaviour::stage::set_stage_entry_popup_burst,
            behaviour::stage::set_stage_prompt_timeouts_enabled,
            behaviour::stage::set_stage_prompt_timeout_multiplier,
            behaviour::stage::set_stage_prompt_popup_burst,
            behaviour::stage::set_stage_movement,
            behaviour::stage::set_stage_movement_speed,
            behaviour::stage::set_stage_mitosis,
            behaviour::stage::set_stage_mitosis_values,
            behaviour::stage::set_stage_end_duration,
            behaviour::stage::set_stage_end_event_count,
            behaviour::stage::set_stage_end_strategy,
            behaviour::transition::set_transition_duration,
            behaviour::transition::set_transition_easing,
            behaviour::transition::set_transition_affected,
            behaviour::transition::set_transition_category,
            behaviour::attributes::set_popup_weight,
            behaviour::attributes::set_popup_scale,
            behaviour::attributes::set_popup_region,
            behaviour::attributes::set_popup_monitor,
