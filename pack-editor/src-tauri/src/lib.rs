...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            behaviour::get_behaviour_summary,
            behaviour::get_text_pool,
            behaviour::add_text_item,
            behaviour::update_text_item,
            behaviour::remove_text_item,
            behaviour::reorder_text_items,
            behaviour::get_web_links,
            behaviour::add_web_link,
            behaviour::update_web_link,
            behaviour::remove_web_link,
            behaviour::get_content_groups,
            behaviour::add_content_group,
            behaviour::update_content_group,
            behaviour::remove_content_group,
            behaviour::get_media_slots,
            behaviour::get_popup_attributes,
            behaviour::get_audio_attributes,
            behaviour::set_popup_attributes,
            behaviour::set_audio_attributes,
            behaviour::get_timeline,
            behaviour::set_timeline_enabled,
            behaviour::set_timeline_label,
            behaviour::add_stage,
            behaviour::duplicate_stage,
            behaviour::move_stage,
            behaviour::remove_stage,
            behaviour::update_stages,
            behaviour::update_transition,
