...
[JSON with Comments](https://code.visualstudio.com/docs/languages/json#_json-with-comments) (JSONC)
...
<Tabs>
  ...
  <TabItem label="enum">
    ...
    The runtime value of `lewdware.config["theme"]` will be the selected key (e.g. `"dark"`).
  </TabItem>
</Tabs>
