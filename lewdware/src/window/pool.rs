...
use crate::window::{RenderTarget, WindowState};
...
impl WindowPool {
    ...
    pub fn release(&mut self, state: WindowState, target: RenderTarget) {
...
impl WindowPool {
    ...
    pub fn release(&mut self, _state: WindowState, _target: RenderTarget) {}
}
